...
public class CatRagdollSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        catSpotsList = dataMgr.getSpotsFromName("RAGDOLL", CommonData.APP_CATEGORY);
        ...
        btnMainecoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatRagdollSpotsActivity.this, CatMaineCoonSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_MAINECOON)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnPersian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatRagdollSpotsActivity.this, CatPersianSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_PERSIAN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnRagdoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatRagdollSpotsActivity.this, CatRagdollSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_RAGDOLL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSiamese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatRagdollSpotsActivity.this, CatSiameseSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_SIAMESE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
