 ...
 */
public class CatSpecialFormulaActivity extends BaseFormulaActivity {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cat_special_formula);

        subId = CommonData.SUBID_SPECIAL;
            ...
            public void onClick(View v) {
                ...
                switch(selectedLifestyle)
                {
                    case CommonData.LIFESTYLE_KITTEN:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatKittenSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_INDOOR:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatIndoorSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPAYED:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatSpayedSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPECIAL:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatSpecialSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_WET:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatWetSpotsActivity.class);
                        break;
                    default:
                        intent = new Intent(CatSpecialFormulaActivity.this, CatSpecialSpotsActivity.class);
                        break;
        ...
        btnKitten.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpecialFormulaActivity.this, CatKittenFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_KITTEN)
        ...
        btnIndoor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpecialFormulaActivity.this, CatIndoorFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_INDOOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpayed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpecialFormulaActivity.this, CatSpayedFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPAYED)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpecial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpecialFormulaActivity.this, CatSpecialFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPECIAL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpecialFormulaActivity.this, CatWetFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_WET)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
