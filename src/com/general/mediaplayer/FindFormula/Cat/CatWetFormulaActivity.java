 ...
 */
public class CatWetFormulaActivity extends BaseFormulaActivity {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cat_wet_formula);

        subId = CommonData.SUBID_WET;

        // Button Back
        Button btnBack = (Button)findViewById(R.id.cat_wet_formula_btn_back);
            ...
            public void onClick(View v) {
                ...
                switch(selectedLifestyle)
                {
                    case CommonData.LIFESTYLE_KITTEN:
                        intent = new Intent(CatWetFormulaActivity.this, CatKittenSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_INDOOR:
                        intent = new Intent(CatWetFormulaActivity.this, CatIndoorSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPAYED:
                        intent = new Intent(CatWetFormulaActivity.this, CatSpayedSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPECIAL:
                        intent = new Intent(CatWetFormulaActivity.this, CatSpecialSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_WET:
                        intent = new Intent(CatWetFormulaActivity.this, CatWetSpotsActivity.class);
                        break;
                    default:
                        intent = new Intent(CatWetFormulaActivity.this, CatWetSpotsActivity.class);
                        break;
        ...
        btnKitten.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatWetFormulaActivity.this, CatKittenFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_KITTEN)
        ...
        btnIndoor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatWetFormulaActivity.this, CatIndoorFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_INDOOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpayed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatWetFormulaActivity.this, CatSpayedFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPAYED)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpecial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatWetFormulaActivity.this, CatSpecialFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPECIAL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatWetFormulaActivity.this, CatWetFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_WET)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_cat_wet_formula));
    }
}