 ...
 */
public class CatPersianSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_persian_spots);

        // breed button (go back to cat breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.cat_persian_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.cat_persian_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.cat_persian_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatFormulaActivity.class);
                startActivity(intent);
        ...
        btnSpot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (catSpotsList != null && catSpotsList.size() > 1)
                {
                    ...
                    final CatDetailViewDialog dialog = new CatDetailViewDialog(CatPersianSpotsActivity.this, R.style.NoTitleDialog);
                    dialog.show();
        ...
        Button btnSpot2 = (Button)findViewById(R.id.cat_persian_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.cat_persian_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.cat_persian_spots_btn_spot4);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.cat_persian_spots_btn_food);
        ...
        btnMainecoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatMaineCoonSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_MAINECOON)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnPersian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatPersianSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_PERSIAN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnRagdoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatRagdollSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_RAGDOLL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSiamese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatPersianSpotsActivity.this, CatSiameseSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_SIAMESE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_cat_persian_spots));
    }
