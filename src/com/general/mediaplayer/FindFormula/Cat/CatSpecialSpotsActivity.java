 ...
 */
public class CatSpecialSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_special_spots);

        // breed button (go back to cat breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.cat_special_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatSpecialSpotsActivity.this, CatBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.cat_special_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatSpecialSpotsActivity.this, CatLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.cat_special_spots_btn_findformula);
        ...
        catSpotsList = dataMgr.getSpotsFromName("SPECIAL NEEDS", CommonData.APP_CATEGORY);

        // spot buttons --------------------------------------------------------------------------
        Button btnSpot1 = (Button)findViewById(R.id.cat_special_spots_btn_spot1);
        btnSpot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (catSpotsList != null && catSpotsList.size() > 0)
                {
                    ...
                    final CatDetailViewDialog dialog = new CatDetailViewDialog(CatSpecialSpotsActivity.this, R.style.NoTitleDialog);
                    dialog.show();
        ...
        Button btnSpot2 = (Button)findViewById(R.id.cat_special_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.cat_special_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.cat_special_spots_btn_spot4);
        ...
        Button btnSpot5 = (Button)findViewById(R.id.cat_special_spots_btn_spot5);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.cat_special_spots_btn_food);
