    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                switch(selectedLifestyle)
                {
                    case CommonData.LIFESTYLE_KITTEN:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatKittenSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_INDOOR:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatIndoorSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPAYED:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatSpayedSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_SPECIAL:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatSpecialSpotsActivity.class);
                        break;
                    case CommonData.LIFESTYLE_WET:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatWetSpotsActivity.class);
                        break;
                    default:
                        intent = new Intent(CatSpayedFormulaActivity.this, CatSpayedSpotsActivity.class);
                        break;
        ...
        btnKitten.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpayedFormulaActivity.this, CatKittenFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_KITTEN)
        ...
        btnIndoor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpayedFormulaActivity.this, CatIndoorFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_INDOOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpayed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpayedFormulaActivity.this, CatSpayedFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPAYED)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpecial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpayedFormulaActivity.this, CatSpecialFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_SPECIAL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSpayedFormulaActivity.this, CatWetFormulaActivity.class);
                startActivity(intent);
                if (selectedFood < CommonData.LIFESTYLE_WET)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
