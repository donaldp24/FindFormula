 ...
 */
public class CatSiameseSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_siamese_spots);

        // breed button (go back to cat breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.cat_siamese_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.cat_siamese_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.cat_siamese_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatFormulaActivity.class);
                startActivity(intent);
        ...
        catSpotsList = dataMgr.getSpotsFromName("SIAMESE", CommonData.APP_CATEGORY);

        // spot buttons --------------------------------------------------------------------------
        Button btnSpot1 = (Button)findViewById(R.id.cat_siamese_spots_btn_spot1);
        btnSpot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (catSpotsList != null && catSpotsList.size() > 0)
                {
                    ...
                    final CatDetailViewDialog dialog = new CatDetailViewDialog(CatSiameseSpotsActivity.this, R.style.NoTitleDialog);
                    dialog.show();
        ...
        Button btnSpot2 = (Button)findViewById(R.id.cat_siamese_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.cat_siamese_spots_btn_spot3);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.cat_siamese_spots_btn_food);
        ...
        btnMainecoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatMaineCoonSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_MAINECOON)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnPersian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatPersianSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_PERSIAN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnRagdoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatRagdollSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_RAGDOLL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSiamese.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatSiameseSpotsActivity.this, CatSiameseSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_SIAMESE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
