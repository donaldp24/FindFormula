 ...
 */
public class CatIndoorSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_indoor_spots);

        // breed button (go back to cat breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.cat_indoor_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.cat_indoor_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.cat_indoor_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatIndoorFormulaActivity.class);
                startActivity(intent);
        ...
        btnSpot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (catSpotsList != null && catSpotsList.size() > 0)
                {
                    ...
                    final CatDetailViewDialog dialog = new CatDetailViewDialog(CatIndoorSpotsActivity.this, R.style.NoTitleDialog);
                    dialog.show();
        ...
        Button btnSpot2 = (Button)findViewById(R.id.cat_indoor_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.cat_indoor_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.cat_indoor_spots_btn_spot4);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.cat_indoor_spots_btn_food);
        ...
        btnKitten.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatKittenSpotsActivity.class);
                startActivity(intent);
                if (selectedLifestyle < CommonData.LIFESTYLE_KITTEN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnIndoor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatIndoorSpotsActivity.class);
                startActivity(intent);
                if (selectedLifestyle < CommonData.LIFESTYLE_INDOOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpayed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatSpayedSpotsActivity.class);
                startActivity(intent);
                if (selectedLifestyle < CommonData.LIFESTYLE_SPAYED)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnSpecial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatSpecialSpotsActivity.class);
                startActivity(intent);
                if (selectedLifestyle < CommonData.LIFESTYLE_SPECIAL)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CatIndoorSpotsActivity.this, CatWetSpotsActivity.class);
                startActivity(intent);
                if (selectedLifestyle < CommonData.LIFESTYLE_WET)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_cat_indoor_spots));
    }
