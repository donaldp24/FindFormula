 ...
 */
public class DogIndoorFormulaActivity extends BaseFormulaActivity {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dog_indoor_formula);

        // Button Back
        Button btnBack = (Button)findViewById(R.id.dog_indoor_formula_btn_back);
            ...
            public void onClick(View v) {
                ...
                switch (selectedSize)
                {
                    case CommonData.SIZE_URBAN:
                        intent = new Intent(DogIndoorFormulaActivity.this, DogUrbanSpotsActivity.class);
                        break;
                    case CommonData.SIZE_INDOOR:
                        intent = new Intent(DogIndoorFormulaActivity.this, DogIndoorSpotsActivity.class);
                        break;
                    case CommonData.SIZE_SPORTING:
                        intent = new Intent(DogIndoorFormulaActivity.this, DogSportingSpotsActivity.class);
                        break;
                    default:
                        intent = new Intent(DogIndoorFormulaActivity.this, DogUrbanSpotsActivity.class);
                        break;
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_dog_indoor_formula));
    }
}