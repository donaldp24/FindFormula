 ...
 */
public class DogUrbanSpotsActivity extends BaseSpotsActivity {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dog_urban_spots);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DogUrbanSpotsActivity.this, ScanMediaActivity.class);
        ...
        btnFindFormula = (Button)findViewById(R.id.dog_urban_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                _appPrefs.setSelectedFood(CommonData.SIZE_URBAN);

                Intent intent = new Intent(DogUrbanSpotsActivity.this, DogUrbanFormulaActivity.class);
                startActivity(intent);
        ...
        dogSpotsList = dataMgr.getSpotsFromName("URBAN", CommonData.APP_CATEGORY);

        // spot buttons --------------------------------------------------------------------------
        Button btnSpot1 = (Button)findViewById(R.id.dog_urban_spots_btn_spot1);
        ...
        Button btnSpot2 = (Button)findViewById(R.id.dog_urban_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.dog_urban_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.dog_urban_spots_btn_spot4);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.dog_urban_spots_btn_food);
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_dog_urban_spots));
    }
