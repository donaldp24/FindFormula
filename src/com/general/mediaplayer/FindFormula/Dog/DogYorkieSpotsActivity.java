 ...
 */
public class DogYorkieSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dog_yorkie_spots);

        // breed button (go back to dog breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.dog_yorkie_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.dog_yorkie_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.dog_yorkie_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogFormulaActivity.class);
                startActivity(intent);
        ...
        dogSpotsList = dataMgr.getSpotsFromName("Yorkshire Terrier", CommonData.APP_CATEGORY);

        // spot buttons --------------------------------------------------------------------------
        Button btnSpot1 = (Button)findViewById(R.id.dog_yorkie_spots_btn_spot1);
        btnSpot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dogSpotsList != null && dogSpotsList.size() > 0)
                {
                    ...
                    final CatDetailViewDialog dialog = new CatDetailViewDialog(DogYorkieSpotsActivity.this, R.style.NoTitleDialog);
                    dialog.show();
        ...
        Button btnSpot2 = (Button)findViewById(R.id.dog_yorkie_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.dog_yorkie_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.dog_yorkie_spots_btn_spot4);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.dog_yorkie_spots_btn_food);
        ...
        btnBeagle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogBeagleSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_BEAGLE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        BtnBulldog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogBulldogSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_BULLDOG)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnChihuahua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogChihuahuaSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_CHIHUAHUA)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnGerman.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogGermanSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_GERMAN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnLabrador.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogLabradorSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_LABRADOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnShih.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogShihSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_SHIH)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWestie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogWestieSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_WESTIE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnYorkie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogYorkieSpotsActivity.this, DogYorkieSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_YORKIE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_dog_yorkie_spots));
    }
