 ...
 */
public class DogShihSpotsActivity extends BaseSpotsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dog_shih_spots);

        // breed button (go back to dog breed sel screen)
        Button btnBreed = (Button)findViewById(R.id.dog_shih_spots_btn_breed);
        btnBreed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DogShihSpotsActivity.this, DogBreedSelActivity.class);
        ...
        Button btnLifestyle = (Button)findViewById(R.id.dog_shih_spots_btn_lifestyle);
        btnLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DogShihSpotsActivity.this, DogLifestyleSelActivity.class);
                startActivity(intent);
                overridePendingTransition(TransformManager.GetBackInAnim(), TransformManager.GetBackOutAnim());
                finish();
            }
        ...
        btnFindFormula = (Button)findViewById(R.id.dog_shih_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogFormulaActivity.class);
                startActivity(intent);
        ...
        btnBeagle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogBeagleSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_BEAGLE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        BtnBulldog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogBulldogSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_BULLDOG)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnChihuahua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogChihuahuaSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_CHIHUAHUA)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnGerman.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogGermanSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_GERMAN)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnLabrador.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogLabradorSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_LABRADOR)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnShih.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogShihSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_SHIH)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnWestie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogWestieSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_WESTIE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        btnYorkie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DogShihSpotsActivity.this, DogYorkieSpotsActivity.class);
                startActivity(intent);
                if (selectedBreed < CommonData.BREED_YORKIE)
                    overridePendingTransition(TransformManager.GetContinueInAnim(), TransformManager.GetContinueOutAnim());
                else
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_dog_shih_spots));
    }
