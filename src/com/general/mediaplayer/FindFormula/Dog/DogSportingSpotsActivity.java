 ...
 */
public class DogSportingSpotsActivity extends BaseSpotsActivity {


    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dog_sporting_spots);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DogSportingSpotsActivity.this, ScanMediaActivity.class);
        ...
        btnFindFormula = (Button)findViewById(R.id.dog_sporting_spots_btn_findformula);
        btnFindFormula.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                _appPrefs.setSelectedFood(CommonData.SIZE_SPORTING);

                Intent intent = new Intent(DogSportingSpotsActivity.this, DogSportingFormulaActivity.class);
                startActivity(intent);
        ...
        dogSpotsList = dataMgr.getSpotsFromName("SPORTING", CommonData.APP_CATEGORY);

        // spot buttons --------------------------------------------------------------------------
        Button btnSpot1 = (Button)findViewById(R.id.dog_sporting_spots_btn_spot1);
        ...
        Button btnSpot2 = (Button)findViewById(R.id.dog_sporting_spots_btn_spot2);
        ...
        Button btnSpot3 = (Button)findViewById(R.id.dog_sporting_spots_btn_spot3);
        ...
        Button btnSpot4 = (Button)findViewById(R.id.dog_sporting_spots_btn_spot4);
        ...
        Button btnSpotFood = (Button)findViewById(R.id.dog_sporting_spots_btn_food);
        ...
        ResolutionSet._instance.iterateChild(findViewById(R.id.layout_dog_sporting_spots));
    }
}